...
<div class="search<?php echo $params->get('moduleclass_sfx') ?>">
		<?php
			...
			<input name="searchword" id="mod-search-searchword" maxlength="'.$maxlength.'" alt="'.$button_text.'" class="inputbox'.$moduleclass_sfx.'" type="text" size="'.$width.'" value="'.$text.'"  onblur="if(this.value==\'\') this.value=\''.$text.'\';" onfocus="if(this.value==\''.$text.'\') this.value=\'\';" onkeyup="s5AjaxSearch();" />
				<span>
					<div alt="" style="background:url('.JURI::base().'modules/mod_s5_live_search/images/loading.gif'.') no-repeat; display:none; margin-left:'.$icon_ml.'px; margin-top:'.$icon_mt.'px; height:'.$icon_height.'px;width:16px" id="loading_img"></div>
				</span>';
			if ($button == "Yes") :
			    if ($imagebutton) :
