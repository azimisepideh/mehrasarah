...
<script type="text/javascript" src="//maps.google.com/maps/api/js?v=3.exp&sensor=false&key=AIzaSyB6hsjubq-AuBoV5xKbuAmxiwHWarzwNqI"></script><script type="text/javascript">
//<![CDATA[
 var geocoder;
 var map;
...
map.setCenter(results[0].geometry.location);
			...
			var image = new google.maps.MarkerImage(' <?php if ($s5mapitimagemarker != "") {  ?><?php echo $LiveSiteUrl;?>/images/<?php echo $s5mapitimagemarker;?><?php } else {?><?php echo $LiveSiteUrl;?>/modules/mod_S5MapIt/images/tack.png<?php }?>',
